        ...
        if d == 1:
            ...
            match e:
                case 1:
                    ...
                    print ("Убийуца медленно начинает приближаться к вам, а хозяин таверны в это время выбегает из комнаты, после чего запирает за собой дверь.")
                ...
                case 2:
                    ...
                    print ("Вы непонимаете, что могло вызвать у него улыбку, и решаете спросить его об этом.")
